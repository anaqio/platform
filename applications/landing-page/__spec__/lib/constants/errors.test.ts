...
describe('ERROR_MESSAGES', () => {
  it('exports GENERIC message', () => {
    expect(ERROR_MESSAGES.GENERIC).toBe('Something went wrong. Please try again later.')
  })

  it('exports GENERIC_SHORT message', () => {
    expect(ERROR_MESSAGES.GENERIC_SHORT).toBe('Something went wrong. Please try again.')
  })
  ...
  it('exports VALID_EMAIL message', () => {
    expect(ERROR_MESSAGES.VALID_EMAIL).toBe('Please provide a valid email address.')
  })
