...
export function AnaqioLogo({ className, theme = 'light', size = 40 }: AnaqioLogoProps) {
  ...
  return (
    <div className={cn('flex items-center gap-3', className)} aria-label="Anaqio" role="img">
      {/* Graphic mark */}
      <Image
        ...
        width={graphicWidth}
        height={size}
        className={cn('shrink-0', theme === 'dark' ? 'brightness-0 invert' : '')}
        priority
      />
