...
import type { CampaignType, CampaignPlatform } from "@/types/database";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 rounded-md bg-primary px-3 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-colors">
                ...
                <div className="mt-4 flex gap-6 border-t border-border pt-3">
                  <div>
                    ...
                    <p className="text-sm font-medium tabular-nums">
                      {campaign.signups_total}
                    </p>
                  </div>
                  <div>
                    <span className="text-xs text-muted-foreground">Invited</span>
                    <p className="text-sm font-medium tabular-nums">
                      {campaign.signups_invited}
                    </p>
                  </div>
                  <div>
                    <span className="text-xs text-muted-foreground">Active</span>
                    <p className="text-sm font-medium tabular-nums">
                      {campaign.signups_active}
                    </p>
                  </div>
